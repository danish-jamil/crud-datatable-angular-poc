	...
	isEditable(currentUserId: Number): boolean {
		return (
			(this.UserId !== currentUserId &&
				this.BusinessLevelDisplayName === Coupons.BusinessLevelDisplayName.PersonalShared) ||
			(_Global.Constant.asi.isCorp !== 'True' &&
				this.BusinessLevelDisplayName === Coupons.BusinessLevelDisplayName.Corporate)
		);
	}
